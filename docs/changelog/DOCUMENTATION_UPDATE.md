...
### 笔记编辑页体验优化（Task 7.5.2～7.6.2）文档同步

1. **`README.md`**
   - ✅ 在「最近更新」最前面新增「笔记编辑页体验优化（2026-03）」章节
   - ✅ 核心功能「笔记管理」补充：分段编辑、长文目录
   - ✅ 用户体验补充：长文目录入口
   - ✅ 项目结构补充：`NoteEditor.tsx`、`SegmentedEditor.tsx`、`outline-utils.ts`

2. **`docs/changelog/CHANGELOG.md`**
   - ✅ 新增「2026-03-XX」章节，记录 Task 7.5.2～7.6.2 实现内容

3. **`docs/features/NOTE_EDITOR_OPTIMIZATION.md`**
   - ✅ 补充「已实现功能」章节，标注元信息行、目录、聚焦态、Placeholder 等已落地

4. **`docs/tasks/NOTE_ENHANCEMENT_TASKS.md`**
   - ✅ Task 7.5.2、7.5.3、7.6.1、7.6.2 状态已更新为「✅ 已完成」（此前已完成）
