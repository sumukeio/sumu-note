...
| issue002 | [ ] | P1 | iPhone 登录后进不去（task013 续修，待真机确认） | [分诊](../phases/phase-bug-triage-mindnote-sunset-20260916/issue_triage_20260916.md#issue002----iphone-8-plus-浏览器无法使用) |
